...
function Navbar() {
    ...
    return (
        <div className="shadow-lg bg-theme-1-3 text-theme-1-1 fixed z-50 top-0 left-0 flex flex-row gap-8 p-6 w-full justify-between items-center font-bold text-xl">
            <Link to="home" className="hidden sm:block relative text-2xl cursor-pointer" spy={true} smooth={true} offset={-150} duration={500} onClick={() => { handleClick(); setHomeClicked(true) }}>Krishnasankar
            ...
            <Link to="home" className="sm:hidden relative text-2xl cursor-pointer" spy={true} smooth={true} offset={-150} duration={500} onClick={() => { handleClick(); setHomeClicked(true) }}>Krishna
            ...
            <div className="flex flex-row items-center justify-between gap-14">
                <Link to="home" className="relative cursor-pointer hidden lg:block" spy={true} smooth={true} offset={-150} duration={500} onClick={() => { handleClick(); setHomeClicked(true) }}  onMouseEnter={() => setHomeHovered(true)} onMouseLeave={() => setHomeHovered(false)}>Home
                ...
                <a href="https://api.whatsapp.com/send?phone=917306310132" className="flex items-center p-4 text-md text-theme-1-1 cursor-pointer relative">
