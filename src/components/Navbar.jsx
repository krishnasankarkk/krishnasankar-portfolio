    ...
    return (
        <div className="shadow-lg bg-theme-1-3 text-theme-1-1 fixed z-50 top-0 left-0 flex flex-row gap-8 p-6 w-full xs:justify-center md:justify-between items-center font-bold text-xl">
            ...
            <div className="flex flex-row items-center justify-between gap-14">
                ...
                <a href="https://api.whatsapp.com/send?phone=917306310132" className="flex items-center p-4 text-md text-theme-1-1 cursor-pointer bg-theme-1-3 hover:bg-theme-1-4 border-2 border-theme-1-1 hover:border-theme-1-1 w-40 justify-center h-12 rounded-tl-[85%] rounded-tr-[68%] rounded-bl-[76%] rounded-br-[53%]">Let&apos;s chat</a>
            </div>
        </div>
    )
}
