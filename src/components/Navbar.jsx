...
function Navbar() {
    ...
    return (
        <div className="bg-theme-1-4 text-theme-1-1 fixed z-50 top-0 left-0 flex flex-row gap-8 p-6 w-full sm:justify-center md:justify-between items-center font-bold text-xl">
            <Link to="home" className="relative text-2xl cursor-pointer" spy={true} smooth={true} offset={-200} duration={500}>Krishnasankar
            ...
            <div className="flex flex-row items-center justify-between gap-14">
                <Link to="home" className="relative cursor-pointer hidden md:block" spy={true} smooth={true} offset={-200} duration={500} onMouseEnter={() => setHomeHovered(true)} onMouseLeave={() => setHomeHovered(false)}>Home
                ...
                <Link to="about" className="relative cursor-pointer hidden md:block" spy={true} smooth={true} offset={-200} duration={500} onMouseEnter={() => setAboutHovered(true)} onMouseLeave={() => setAboutHovered(false)}>About
                ...
                <Link to="skills" className="relative cursor-pointer hidden md:block" spy={true} smooth={true} offset={-200} duration={500} onMouseEnter={() => setSkillsHovered(true)} onMouseLeave={() => setSkillsHovered(false)}>Skills
                ...
                <Link to="projects" className="relative cursor-pointer hidden md:block" spy={true} smooth={true} offset={-200} duration={500} onMouseEnter={() => setProjectsHovered(true)} onMouseLeave={() => setProjectsHovered(false)}>Projects
                ...
                <Link to="contact" className="relative cursor-pointer hidden md:block" spy={true} smooth={true} offset={-200} duration={500} onMouseEnter={() => setContactHovered(true)} onMouseLeave={() => setContactHovered(false)}>Contact
                ...
                <span className="absolute top-1 left-0 -z-10  bg-theme-1-4 border-2 border-theme-1-3 w-24 h-12 rounded-tl-[85%] rounded-tr-[68%] rounded-bl-[76%] rounded-br-[53%]"></span></span>
            </div>
        </div>
    )
}
