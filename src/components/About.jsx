function About() {
    return (
        <section className="relative mt-52 w-full flex flex-col md:flex-row items-center justify-evenly p-4 gap-14" id="about">
          <div className="relative flex flex-col bg-theme-1-3 w-72 xs:w-96 sm:w-[40rem] h-52 rounded-tl-[55%] rounded-tr-[68%] rounded-bl-[56%] rounded-br-[43%] rounded-custom">
            ...
            <a href="https://api.whatsapp.com/send?phone=917306310132" className="absolute -bottom-20 left-0 z-10 hidden md:flex flex-row gap-1 w-60 h-auto items-center justify-center mt-24 bg-theme-1-4 border-2 border-theme-1-3 hover:border-theme-1-1 hover:bg-theme-1-3 p-4 rounded-tl-[45%] rounded-tr-[58%] rounded-bl-[46%] rounded-br-[43%] custom-pointer">
          ...
          <div className="flex flex-col items-center justify-center gap-6 text-2xl">
            <a className="flex flex-row items-center justify-center gap-2 w-auto h-auto" href="https://www.linkedin.com/in/krishnasankarkk/">
              ...
              <span className="block md:hidden lg:hidden xl:block font-bold bg-theme-1-4 w-10 h-6 rounded-tl-[55%] rounded-tr-[68%] rounded-bl-[56%] rounded-br-[43%] rounded-custom custom-pointer border-2 border-theme-1-3">LinkedIn</span></a>
            <a className="flex flex-row items-center justify-center gap-2 w-auto h-auto" href="https://github.com/krishnasankarkk">
              ...
              <span className="block md:hidden lg:hidden xl:block font-bold bg-theme-1-4 w-10 h-6 rounded-tl-[55%] rounded-tr-[68%] rounded-bl-[56%] rounded-br-[43%] rounded-custom custom-pointer border-2 border-theme-1-3">Github</span></a>
