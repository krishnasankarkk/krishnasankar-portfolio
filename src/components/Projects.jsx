...
// ];
    ...
    return (
        <section className="w-full h-auto flex flex-col items-center justify-center rounded-2xl relative gap-2 pt-24" id="projects">
          <span className="font-extrabold text-2xl underline mt-4">Projects</span>
          <a href="https://github.com/krishnasankarkk/django-keralagram" className="flex flex-col lg:flex-row gap-4 xs:items-center md:items-start justify-center bg-theme-1-4 border-2 border-theme-1-3 w-[80%] h-auto rounded-2xl p-8 m-4 hover:bg-theme-1-3 hover:border-theme-1-1 cursor-pointer">
          ...
          <a href="https://github.com/krishnasankarkk/kwikmart" className="flex flex-col lg:flex-row gap-4 xs:items-center md:items-start justify-center bg-theme-1-4 border-2 border-theme-1-3 w-[80%] h-auto rounded-2xl p-8 m-4 hover:bg-theme-1-3 hover:border-theme-1-1 cursor-pointer">
          ...
          <a href="https://github.com/krishnasankarkk/pygame-alien-invasion" className="flex flex-col lg:flex-row gap-4 xs:items-center md:items-start justify-center bg-theme-1-4 border-2 border-theme-1-3 w-[80%] h-auto rounded-2xl p-8 m-4 hover:bg-theme-1-3 hover:border-theme-1-1 cursor-pointer">
